...
class DesktopHeader extends StatelessWidget{
  ...
  const DesktopHeader({required this.controller, super.key});
              ...
              GradientAnimationText(
                  ...
                  text: Text(
                        ...
                        RippleAnimation(
                          ...
                          repeat: true,
                          ripplesCount: 3,
                          minRadius: Globals.width! / Globals.width_10 * 3,
                          child: IconButton(onPressed: (){
                              controller.animateTo(Globals.height! + 50, duration: const Duration(seconds: 1), curve: Curves.easeInOut);
                            }, icon: Icon(Iconsax.arrow_down_1_outline, color: AppColors.dark_purple, size: Globals.width! / Globals.size_32,)),
                        )
            ],
          ),
        ),
